...
import '../ortu_pages/detail_page.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  UpdateCard(
                    ...
                    description: 'Lorem ipsum dolor sit amet consectetur. Dolor interdum odio quam sed aliquam.',
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (_) => UpdateDetailPage(
                            title: 'Kado Cinta Ramadhan',
                            description: 'Lorem ipsum dolor sit amet consectetur. Dolor interdum odio quam sed aliquam.',
                            imageUrl: 'assets/images/placeholder_updates.jpg',// Aksi saat card di klik
...
class _OutingClassSliderState extends State<OutingClassSlider> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        CarouselSlider(
          items: outingClasses.map((outingClass) {
            return Card(
                ...
                children: [
                  ...
                  Stack(
                    children: [
                      // Gambar
                      ClipRRect(
                        borderRadius: BorderRadius.vertical(top: Radius.circular(16), bottom: Radius.circular(16)), // Radius pada gambar
                        child: Container(
                          height: 212, // Menyesuaikan tinggi card dengan gambar
                          // width: double.infinity, // Menyesuaikan lebar card dengan gambar
                          decoration: BoxDecoration(
                          ...
                          child: Image.asset(
                            outingClass['image']!,
                            fit: BoxFit.cover, // Memastikan gambar mengisi penuh area
                            height: 212,
                            width: double.infinity,
                          ),
                        ),
                      ),
                      // Teks yang ada di atas gambar
                      Positioned(
        ...
        Row(
          ...
          children: outingClasses.asMap().entries.map((entry) {
