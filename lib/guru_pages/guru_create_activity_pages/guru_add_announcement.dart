...
class _AddAnnouncementPageState extends State<AddAnnouncementPage> {
  ...
  // Fungsi untuk mengirimkan notifikasi berdasarkan status reminder
  // Future<void> _sendAnnouncementNotification(String classId) async {
  //   final String title = namaKegiatanController.text;
  //   final String body = deskripsiController.text;

  //   if (kirimSekarang) {
  //     await _notificationService.sendNotificationToOrangtua(
  //       classId: classId,
  //       title: title,
  //       body: body,
  //     );
  ...
  //     // Implementasi logika pengingat 1 hari sebelumnya (misalnya, menggunakan scheduler)
  ...
  //     );
  //   }
  //   if (duaBelasJamSebelum) {
  //     final reminderDate = selectedDate.subtract(Duration(hours: 12));
  //     // Implementasi logika pengingat 12 jam sebelumnya (misalnya, menggunakan scheduler)
  //     _scheduleNotification(
  //       reminderDate,
  //       classId,
  //       title,
  ...
  Future<void> _scheduleNotification(
    ...
    // Kamu bisa menggunakan paket seperti `flutter_local_notifications` untuk menjadwalkan notifikasi lokal
    print('Notifikasi $reminderLabel dijadwalkan pada: $date');
    // Placeholder logika untuk notifikasi yang dijadwalkan
  }
            ...
            child: ElevatedButton(
              onPressed: () async {
                ...
                try {
                  ...
                  // await _sendAnnouncementNotification(widget.classId);
